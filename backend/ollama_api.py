...
from backend.functions import reduksi as rd
import openai
import time
from backend.functions import trans_id as trn
import requests
import random
...
#     )
    ...
    response: ChatResponse = chat(model='qwen2.5:14b', messages=conv_obj.messages)
